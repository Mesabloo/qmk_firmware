...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_ALPHA] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX, FR_Z, FR_X, FR_C,    FR_V,     FR_B,           /**/ FR_K,           FR_M,      FR_COMM,        FR_SCLN, LT(LAYER_FN, FR_COLN), XXXXXXX,
                             KC_LGUI, TAB_UPPR, LSFT_T(KC_SPC), /**/ LCTL_T(KC_ENT), BSPC_LOWR, RALT_T(KC_RCTL)
    ),
    ...
    [LAYER_SYMB] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX, FR_LABK, FR_DIAE, FR_CIRC, OSL(LAYER_ACC), OSL(LAYER_GRV), /**/ FR_MINS, FR_EQL,  FR_LBRC, FR_RBRC, FR_BSLS, XXXXXXX,
        XXXXXXX, FR_GRV,  FR_QUOT, FR_CCED, XXXXXXX,        FR_TILD,        /**/ FR_UNDS, FR_PLUS, FR_LCBR, FR_RCBR, FR_PIPE, XXXXXXX,
                                   _______, _______,        _______,        /**/ _______, _______, _______
    ),
